...
**Sprint 6 transaction candidate (`0.2.0-alpha.22`):** GM-approved buying and selling now
...
1. Obtain the packaged ZIP from the successful **Validate and package** GitHub Actions run
   ...
   first and select `devils-table-v0.2.0-alpha.22.zip` for import.
...
custom-package method, restart/reload the test world and confirm the module shows `0.2.0-alpha.22`.
